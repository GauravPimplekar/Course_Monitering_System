...
public class MainApplication {
	...
	public static void admin() {
		try {
		Administrator admin = new Administrator("g", "g");
		...
		case 1:
			...
			try {
				...
				case 5: System.out.println("     1) Allocate faculty to a batch");
						...
						default: WrongInputException wr = new WrongInputException("Wrong Input");
								wr.printStackTrace();
								break;
						}
	...
	public static void faculty() {
		 try {
					Scanner sc = new Scanner(System.in);
					FacultyLogin faculty = new FacultyLogin("ratan2022", "RS#masai");
